<?php
  class Request_model extends CI_Model{
    ...
    function get_user_requests($id_user){
      $this->db->select('request.id, date, start_date_justification, end_date_justification, type_request.detail as type_request_detail, request_state.detail as request_state_detail, id_request_state');
